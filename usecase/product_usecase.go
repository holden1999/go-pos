...
func (p *productUseCase) ListProduct(limit, skip, categoryId int, query string) []model.ProductResp {
	return p.productRepo.ListProduct(limit, skip, categoryId, query)
}
